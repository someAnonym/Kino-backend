...
class PersonMapper {
    static mapToDomain(person) {
        ...
        return new person_entity_1.PersonEntity(id, person.name, person.englishName, person.linkToBiography, person.career, person.height, person.birthday, person.bornPlace, person.genres, person.totalCountOfFilmsAndYears, person.favorites, awards, bestFilms, person.lastNews, person.photos, films, person.comments);
    }
}
